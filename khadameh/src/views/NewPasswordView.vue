...
<template>
    <div class="flex w-full justify-center items-center h-screen 2xl:p-24">
        <LoginSlider />
        <section class=" flex md:w-1/2 w-full h-full flex-col items-center pt-10 md:pt-16 pb-8 md:py-34 2xl:py-14  md:mx-40 2xl:mx-52 xl:w-1/2">
            <BackArrow text="بازگشت" />
